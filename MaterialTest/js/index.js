var app = angular.module('codeVantage', ['ngMaterial', 'ngMdIcons']);
...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
  ...
  $scope.showSettings = function(ev) {
    $mdDialog.show({
      ...
      template: '<md-dialog aria-label="Mango (Fruit)"> <md-content class="md-padding">  <md-button ng-click="answer(\'not useful\')"> Cancel </md-button> <md-button ng-click="answer(\'useful\')" class="md-primary"> Save </md-button> </div></md-dialog>',
      targetEvent: ev,
    })
  };
